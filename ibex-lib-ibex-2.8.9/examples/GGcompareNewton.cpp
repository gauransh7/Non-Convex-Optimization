...
Matrix FindTestVectors(int n){
    return ibex::Matrix::rand(100,n);
}
...
int main(int argc, char **argv)
{
    ...
    Matrix test_vectors = FindTestVectors(n);
    int our_better = 0, total_test = 0;
    for(int p = 0 ; p < 100 ; p++){
        // cout << "Initial guess: ";
    ...
    cout << "total " << total_test << " , better : " << our_better << "\n";
    return 0;
}
